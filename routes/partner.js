...
import { createPartner, getAllPartners, approvePartner, rejectPartner, getPartner, updatePartner } from '../controllers/partnerController.js';
...
router.put('/updateProfile', [requireRole(['partner'])], updatePartner);
